...
$.validator.addMethod("mobileCN", function(value, element) {
	return this.optional(element) || /^[1]([3][0-9]{1}|[4][0-9]{1}|[5][0-9]{1}|[7][0-9]{1}|[8][0-9]{1})[0-9]{8}$/.test(value);
}, "请输入正确的手机号");

//验证ipv4
$.validator.addMethod("ipV4", function(value, element) {
	return this.optional(element) || /((2[0-4]\\d|25[0-5]|\\d{1,2}|1\\d\\d)\\.){3}(2[0-4]\\d|25[0-5]|\\d{1,2}|1\\d\\d)/.test(value);
}, "请输入正确的IP地址,例如192.168.0.1");
